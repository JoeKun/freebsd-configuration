...
Clone a new ports tree for the current quarterly branch from FreeBSD’s official ports tree: `2026Q2`.

```console
# poudriere ports -c -p 2026Q2 -B 2026Q2
```
...
# ln -s my_poudriere-amd64-15-0-2026Q2 my_poudriere-amd64-15-0-quarterly
```
...
Clone a new ports tree for the new quarterly branch from FreeBSD’s official ports tree: `2026Q3`.
...
# ln -s my_poudriere-amd64-15-0-2026Q3 my_poudriere-amd64-15-0-quarterly
```
...
```console
# poudriere pkgclean -A -j my_poudriere-amd64-15-0 -p 2026Q2
# poudriere distclean -p 2026Q2 -f /usr/local/etc/poudriere.d/pkglist
# poudriere logclean -j my_poudriere-amd64-15-0 -p 2026Q2 -a
```

Then, the old ports tree itself can be removed.

```console
# poudriere ports -d -p 2026Q2
```
...
# rm -R -f packages/my_poudriere-amd64-15-0-2026Q2
# rmdir cache/my_poudriere-amd64-15-0-2026Q2
# rmdir .m/my_poudriere-amd64-15-0-2026Q2

# cd /var/run/poudriere
# rm -f lock-poudriere-shared-json_jail_my_poudriere-amd64-15-0-2026Q2.flock
# rm -f lock-poudriere-shared-json_jail_my_poudriere-amd64-15-0-2026Q2.pid
# rm -f lock-poudriere-shared-jail_start_my_poudriere-amd64-15-0-2026Q2.flock
# rm -f lock-poudriere-shared-jail_start_my_poudriere-amd64-15-0-2026Q2.pid
```
