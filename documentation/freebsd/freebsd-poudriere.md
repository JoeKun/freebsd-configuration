...
Clone a new ports tree for the current quarterly branch from FreeBSD’s official ports tree: `2026Q1`.
...
Clone a new ports tree for the new quarterly branch from FreeBSD’s official ports tree: `2026Q2`.
...
```console
# poudriere pkgclean -A -j my_poudriere-amd64-15-0 -p 2026Q1
# poudriere distclean -p 2026Q1 -f /usr/local/etc/poudriere.d/pkglist
# poudriere logclean -j my_poudriere-amd64-15-0 -p 2026Q1 -a
```

Then, the old ports tree itself can be removed.

```console
# poudriere ports -d -p 2026Q1
```
...
# rm -R -f packages/my_poudriere-amd64-15-0-2026Q1
# rmdir cache/my_poudriere-amd64-15-0-2026Q1
# rmdir .m/my_poudriere-amd64-15-0-2026Q1

# cd /var/run/poudriere
# rm -f lock-poudriere-shared-json_jail_my_poudriere-amd64-15-0-2026Q1.flock
# rm -f lock-poudriere-shared-json_jail_my_poudriere-amd64-15-0-2026Q1.pid
# rm -f lock-poudriere-shared-jail_start_my_poudriere-amd64-15-0-2026Q1.flock
# rm -f lock-poudriere-shared-jail_start_my_poudriere-amd64-15-0-2026Q1.pid
```
