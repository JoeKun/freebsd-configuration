...
```
# pkg install postgresql18-client postgresql18-server postgresql18-contrib
# cd /etc/rc.conf.d
...
```
# pkg install sudo bash icu cmake pkgconf node npm phantomjs krb5 gmake go rust libtool bison re2 yarn libgit2 ruby rubygem-bundler meson
```
