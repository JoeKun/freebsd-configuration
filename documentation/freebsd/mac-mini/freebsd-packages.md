...
```
# wget "https://cache.ruby-lang.org/pub/ruby/3.3/ruby-3.3.8.tar.gz"
# tar xvzf ruby-3.3.8.tar.gz
# cd ruby-3.3.8
...
# ./configure --enable-shared --prefix=/opt/rubies/ruby-3.3.8
# make -j4
# make install
# cd ..
# rm -R -f ruby-3.3.8 ruby-3.3.8.tar.gz
```
